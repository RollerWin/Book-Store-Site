...
namespace WebApplication2.Controllers
{
    ...
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,BookId,Count,TotalPrice")] Cart cart)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Books, "Id", "Author", cart.BookId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,BookId,Count,TotalPrice")] Cart cart)
        {
            if (id != cart.Id)
            {
                return NotFound();
