...
namespace WebApplication2.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Catalog()
        {
            ...
            var viewModel = await _context.Books.ToListAsync();
            return View(viewModel);
        }

        [Authorize]
        [HttpPost, ActionName("Catalog")]
        public async Task<IActionResult> Catalog(int bookId)
        {
            ...
            {
                cartItem.Count++;
                cartItem.TotalPrice = cartItem.Count * book.Price;
            }

            var chosenBook = _context.Books.FirstOrDefault(c => c.Id == bookId);
            chosenBook.Count--;
        ...
        private void SetLastVisitCookie()
        {
            ...
            {
                Expires = DateTime.Now.AddMinutes(30) // Устанавливаем время жизни куки на 30 минут
            });
        }
